...
public class ModelTopielec extends ModelBase {
    ...
    public ModelTopielec() {
        ...
        this.Ramie = new ModelRenderer(this, 0, 0);
        this.Ramie.setRotationPoint(-4.4F, 17.0F, 6.4F);
        this.Ramie.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F);
        this.Lydka2 = new ModelRenderer(this, 75, 75);
        this.Lydka2.setRotationPoint(0.0F, 3.0F, 21.7F);
        this.Lydka2.addBox(0.0F, 0.0F, 0.0F, 8, 28, 8, 0.0F);
        this.Lydka1 = new ModelRenderer(this, 75, 75);
        this.Lydka1.setRotationPoint(0.0F, 3.0F, 21.6F);
        ...
        this.Noga2.setRotationPoint(28.0F, 14.5F, 4.0F);
        this.Noga2.addBox(0.0F, 0.0F, 0.0F, 8, 8, 30, 0.0F);
        this.setRotateAngle(Noga2, -0.18203784098300857F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(ydka3, 1.0471975511965976F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(ydka4, 1.0471975511965976F, 0.0F, 0.0F);
        this.tlow.addChild(this.Ramie);
        ...
        this.Ramie.addChild(this.Noga1);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    	...
    	this.Noga4.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 0.6F * limbSwingAmount;
    }
}
