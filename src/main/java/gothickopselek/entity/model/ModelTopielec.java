...
public class ModelTopielec extends ModelBase {
    ...
    public ModelTopielec() {
        ...
        this.Noga1.setRotationPoint(-7.8F, 18.0F, 1.2F);
        this.Noga1.addBox(0.0F, 0.0F, 0.0F, 8, 32, 8, 0.0F);
        this.setRotateAngle(Noga1, 1.3203415791337103F, 0.0F, 0.0F);
        ...
        this.Noga3.setRotationPoint(-10.0F, 9.6F, 48.2F);
        this.Noga3.addBox(0.0F, 0.0F, 0.0F, 10, 10, 32, 0.0F);
        this.setRotateAngle(Noga3, -1.2747884856566583F, 0.0F, 0.0F);
        this.Noga4 = new ModelRenderer(this, 12, 140);
        this.Noga4.setRotationPoint(27.7F, 9.6F, 48.2F);
        this.Noga4.addBox(0.0F, 0.0F, 0.0F, 10, 10, 32, 0.0F);
        this.setRotateAngle(Noga4, -1.2747884856566583F, 0.0F, 0.0F);
        ...
        this.Noga2 = new ModelRenderer(this, 12, 92);
        this.Noga2.setRotationPoint(28.0F, 18.0F, 1.2F);
        this.Noga2.addBox(0.0F, 0.0F, 0.0F, 8, 30, 8, 0.0F);
        this.setRotateAngle(Noga2, 1.3203415791337103F, 0.0F, 0.0F);
    ...
    {
        this.Noga1.rotateAngleX = 1.3203415791337103F + MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
        this.Noga2.rotateAngleX = 1.3203415791337103F + MathHelper.cos(limbSwing * 0.6662F + (float)Math.PI) * 1.4F * limbSwingAmount;
        this.Noga3.rotateAngleX = -1.2747884856566583F + MathHelper.cos(limbSwing * 0.6662F + (float)Math.PI) * 1.4F * limbSwingAmount;
        this.Noga4.rotateAngleX = -1.2747884856566583F + MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
    }
}
